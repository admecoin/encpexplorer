...
server {
    ...
    #server_name explorer.enceladuscrypto.com;
    server_name _;
    ...
    #ssl_certificate /etc/letsencrypt/live/explorer.enceladuscrypto.com/fullchain.pem; # managed by Certbot
    #ssl_certificate_key /etc/letsencrypt/live/explorer.enceladuscrypto.com/privkey.pem; # managed by Certbot
    #include /etc/letsencrypt/options-ssl-nginx.conf; # managed by Certbot
    #ssl_dhparam /etc/letsencrypt/ssl-dhparams.pem; # managed by Certbot
}

#server {
#    if ($host = explorer.enceladuscrypto.com) {
...
installenceladus () {
    echo "Installing enceladus..."
    mkdir -p /tmp/enceladus
    cd /tmp/enceladus
    wget https://github.com/admecoin/tr/releases/download/1/enceladus.tar.gz
    tar -xzf enceladus.tar.gz
    sudo mv enceladus* /usr/local/bin
    cd
    rm enceladus*
    mkdir -p /home/explorer/.enceladus
    cat > /home/explorer/.enceladus/enceladus.conf << EOL
rpcport=11334
rpcuser=$rpcuser
...
txindex=1
EOL
    sudo cat > /etc/systemd/system/enceladusd.service << EOL
[Unit]
...
ExecStart=/home/explorer/bin/enceladusd -datadir=/home/explorer/.enceladus
ExecStop=/home/explorer/bin/enceladus-cli -datadir=/home/explorer/.enceladus stop
Restart=on-abort
[Install]
WantedBy=multi-user.target
EOL
    sudo systemctl start enceladusd
    sudo systemctl enable enceladusd
...
const config = {
  'api': {
    'host': 'https://explorer.enceladuscrypto.com',
    'port': '3000',
    'prefix': '/api',
    'timeout': '180s'
  },
